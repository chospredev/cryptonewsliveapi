...
const newspapers = [
  ...
  {
    name: "cryptonews",
    address: "https://cryptonews.com/guides/ethereum/",
    baseAddress: "https://cryptonews.com",
  },
  {
    name: "cointelegraph",
    address: "https://cointelegraph.com/ethereum-for-beginners",
...
router.get("/ethereum-today", (req, res) => {
  res.json(articles);
});

router.get("/ethereum/:newspaperId", async (req, res) => {
...
router.get("/investing-today", (req, res) => {
  axios
    .get("https://www.coindesk.com/learn")
    .then((response) => {
      const html = response.data;
      const $ = cheerio.load(html);
